...
class SelectPaymentGateway extends StatefulWidget {
  final PaymentGatewaysBloc paymentGatewaysBloc = PaymentGatewaysBloc();
  @override
  _SelectPaymentGatewayState createState() => _SelectPaymentGatewayState();
}

class _SelectPaymentGatewayState extends State<SelectPaymentGateway> {
